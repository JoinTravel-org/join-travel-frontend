...
const ReviewForm: React.FC<ReviewFormProps> = ({ placeId, onReviewCreated }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (errorMessage.includes("no está autenticado") || errorMessage.includes("not authenticated")) {
                setError("Debe iniciar sesión para reseñar.");
            } else if (errorMessage.includes("almacenamiento") || errorMessage.includes("guardar")) {
